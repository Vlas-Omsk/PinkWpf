...
namespace PinkWpf
{
    public abstract class ObservableStoreBase<TStore> : StoreBase<TStore>, INotifyPropertyChanged, INotifyPropertyChanging
        where TStore : ObservableStoreBase<TStore>, new()
    {
